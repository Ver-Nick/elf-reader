...
<h2>Описание системы кодирования команд RISC-V</h2>
...
![Рис.1: Все инструкции базового набора RV32I.](images/001.jpeg)
<sub><sup>Рис.1: Все инструкции базового набора RV32I.</sup></sub>
...
![Рис.2: Инструкции расширения RV32M.](images/002.jpeg)
<sub><sup>Рис.2: Инструкции расширения RV32M.</sup></sub>
...
![Рис.3: Структура инструкций](images/003.jpeg)
<sub><sup>Рис.3: Структура инструкций</sup></sub>
...
![Рис.4: имена регистров, их идентификаторы в полях rs1, rs2 и rd ](images/004.jpeg)
<sub><sup>Рис.4: имена регистров, их идентификаторы в полях **rs1**, **rs2** и **rd**</sup></sub>
